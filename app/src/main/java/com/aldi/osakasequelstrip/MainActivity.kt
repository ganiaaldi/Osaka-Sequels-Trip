...
class MainActivity : AppCompatActivity() {
    ...
    private val wisataData = arrayListOf(
        WisataModel(
            "Distrik Osaka san-go", "Tiga distrik yang terhubung ini terkenal sebagai surga belanja, " +
        ...
        WisataModel(
            ...
            R.drawable.osakacastle
        ),
        WisataModel(
            "Osaka Aquarium Kaiyukan",
            "Akuarium Osaka Kaiyukan (海遊館 Kaiyūkan) adalah akuarium yang terletak di distrik Minato di Osaka, Jepang, dekat Teluk Osaka. Akuarium ini merupakan salah satu akuarium publik terbesar di dunia, dan merupakan anggota dari Asosiasi Kebun Binatang dan Akuarium Jepang (JAZA).\n" +
                    "\n" +
        ...
        WisataModel(
            "Kuil Shitennoji",
            "Shitennō-ji (Jepang: 四天王寺; juga Arahaka-ji, Nanba-ji, atau Mitsu-ji) adalah sebuah kuil Buddhis di Ōsaka, Jepang. Kuil ini terkadang dianggap sebagai kuil Buddhis pertama dan tertua yang dikelola secara resmi di Jepang,meskipun bangunan kuil telah dibangun kembali selama berabad-abad.\n" +
        ...
        WisataModel(
            ...
            "Gunung Kōya (高野山 Kōya-san) adalah sebutan untuk gunung-gunung yang tingginya sekitar 1.000 m di Prefektur Wakayama, Jepang. Sebutan Kōya-san juga merupakan sebutan lain untuk kuil Buddha bernama Kongōbuji yang terletak di gunung ini. Meskipun demikian, tidak ada gunung di Jepang yang secara resmi bernama Gunung Kōya.\n" +
                    ...
                    "Pada tahun 2004, UNESCO menetapkan Gunung Kōya bersama-sama dengan dua lokasi lainnya di Semenanjung Kii sebagai Situs Warisan Dunia.",
            R.drawable.koya
        ),
        WisataModel(
            "Umeda Sky Building",
            "Umeda (梅田) adalah distrik bisnis, komersial, perbelanjaan dan hiburan utama di Distrik Kita, Osaka, Jepang. Nama harfiah distrik ini berarti \"ladang bunga prem\". \n" +
        ...
        WisataModel(
            ...
            "Dari museum ini kemungkinan orang orang yang datang bisa memahami bagaimana kehidupan orang Jepang jaman dahulu, secara di buat semirip dan sedetail baik dari rumah, alat masak, furniture dan lainnya. disini juga dapat menyewa pakaian khas jepang yaitu kimono atau yukata jadi akan berasa lebih hidup suasananya.",
            R.drawable.museum
        ),
        WisataModel(
            "Area Perbelanjaan Tenjinbashisuji",
            "Tempat perbelanjaan Tenjibashi - Suji terletak di Kita-bangsal, Kota Osaka merupakan beratap jalan perbelanjaan terpanjang di Jepang. Jalan perbelanjaan dibagi menjadi enam wilayah, memiliki restoran Osaka-seperti, toko-toko tua yang khusus , toko pakaian dan toko-toko komersial lainnya. Hanya berjalan-jalan di jalan adalah pengalaman yang menyenangkan.\n" +
                    "\n" +
